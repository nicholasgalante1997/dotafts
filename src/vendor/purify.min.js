...
!(function (e, t) {
  ...
  var re = (function t() {
    ...
    const o = (e) => t(e);
    if (((o.version = '3.1.4'), (o.removed = []), !n || !n.document || n.document.nodeType !== te))
    ...
    let fe = {};
    o.isSupported =
      'function' == typeof e && 'function' == typeof ie && ce && void 0 !== ce.createHTMLDocument;
    const {
      MUSTACHE_EXPR: de,
      ERB_EXPR: he,
      TMPLIT_EXPR: ge,
    ...
    const pt = 255,
      ...
      ht = function () {
        ...
        if (!mt || mt !== e) {
          if (
            ((e && 'object' == typeof e) || (e = {}),
            (e = w(e)),
            (lt = -1 === ct.indexOf(e.PARSER_MEDIA_TYPE) ? st : e.PARSER_MEDIA_TYPE),
            (ut = 'application/xhtml+xml' === lt ? d : f),
            (be = y(e, 'ALLOWED_TAGS') ? R({}, e.ALLOWED_TAGS, ut) : Se),
            (Re = y(e, 'ALLOWED_ATTR') ? R({}, e.ALLOWED_ATTR, ut) : ve),
            (it = y(e, 'ALLOWED_NAMESPACES') ? R({}, e.ALLOWED_NAMESPACES, d) : at),
            (Je = y(e, 'ADD_URI_SAFE_ATTR') ? R(w(Qe), e.ADD_URI_SAFE_ATTR, ut) : Qe),
            (Ve = y(e, 'ADD_DATA_URI_TAGS') ? R(w(Ze), e.ADD_DATA_URI_TAGS, ut) : Ze),
            ...
            e.FORBID_CONTENTS && ($e === Ke && ($e = w($e)), R($e, e.FORBID_CONTENTS, ut)),
            je && (be['#text'] = !0),
      ...
      St = function (e) {
        ...
        return (
          ...
          ot === nt ? me.call(t, Ue ? 'html' : 'body')[0] : Ue ? t.documentElement : i
        );
      },
      Rt = function (e) {
        return se.call(
      ...
      Lt = function (e) {
        ...
        if (!be[n] || Ce[n]) {
          if (!Ce[n] && Ot(n)) {
            if (we.tagNameCheck instanceof RegExp && E(we.tagNameCheck, n)) return !1;
          ...
          if (
            !(
              (Ot(e) &&
                ...
                ((we.attributeNameCheck instanceof RegExp && E(we.attributeNameCheck, t)) ||
      ...
      xt = function (e) {
        ...
        if (!t) return;
        const n = { attrName: '', attrValue: '', keepAttr: !0, allowedAttributes: Re };
        let r = t.length;
        for (; r--; ) {
          const i = t[r],
          ...
          if (Dt(f, s, p)) {
            if (
              ...
              ae && 'object' == typeof Y && 'function' == typeof Y.getAttributeType)
            )
              if (l);
              else
            ...
            try {
              l ? e.setAttributeNS(l, a, p) : e.setAttribute(a, p), vt(e) ? Nt(e) : m(o.removed);
            } catch (e) {}
          }
        }
      ...
      kt = function e(t) {
        ...
        for (Ct('beforeSanitizeShadowDOM', t, null); (n = o.nextNode()); ) {
          ...
          n.nodeType === Z &&
            ...
            n.content instanceof s && ((n.content.__depth = n.__depth), e(n.content)),
            xt(n);
        }
    ...
    return (
      (o.sanitize = function (e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          i = null,
          l = null;
        if (((rt = !e), rt && (e = '\x3c!--\x3e'), 'string' != typeof e && !wt(e))) {
        ...
        if ((Pe || ht(t), (o.removed = []), 'string' == typeof e && (Xe = !1), Xe)) {
          if (e.nodeName) {
            const t = ut(e.nodeName);
            if (!be[t] || Ce[t]) throw A('root node is forbidden and cannot be sanitized in-place');
          }
          ...
          if (!He && !Me && !Ue && -1 === e.indexOf('<')) return ae && Be ? ae.createHTML(e) : e;
        ...
        for (; (i = c.nextNode()); ) {
          ...
          i.nodeType === Z &&
            ...
            i.content instanceof s && ((i.content.__depth = i.__depth), kt(i.content)),
            xt(i);
        }
        if (Xe) return e;
        if (He) {
          if (ze) for (l = ue.call(n.ownerDocument); n.firstChild; ) l.appendChild(n.firstChild);
          else l = n;
