...
export const Main: StoryObj<typeof PostCard> = {
    args: {
        ...
        synopsis: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Urna id volutpat lacus laoreet non curabitur. Vulputate ut pharetra sit amet aliquam id. A condimentum vitae sapien pellentesque habitant morbi.',
        media: [
            {
                alt: 'Rick',
